 ...
 */
public class ClassInfo extends BaseJavaClassModelInfo implements ClassFile {
    ...
    private Collection<MethodInfo> methods = new ArrayList<MethodInfo>();
    private Collection<MethodInfo> constructors = new ArrayList<MethodInfo>();
    ...
    public void setConstructors(Collection<MethodInfo> constructors) {
        this.constructors = constructors;
    }

    public void addConstructor(MethodInfo method) {
